...
export const metadata: Metadata = {
  title: "Работа в Яндекс Доставке — Подключение к парку Полный Газ",
  description: "Официальный партнер Яндекс Доставки. Регистрация водителей и курьеров во всех тарифах: Грузовой, Экспресс, Легковой. Моментальные выплаты 24/7, низкая комиссия.",
  ...
  openGraph: {
    title: "Работа в Яндекс Доставке — Подключение к парку Полный Газ",
    description: "Подключайся к Яндекс Доставке на выгодных условиях. Моментальные выплаты, честная комиссия, живая поддержка.",
    type: "website",
    locale: "ru_RU",
    siteName: "Полный Газ",
  },
